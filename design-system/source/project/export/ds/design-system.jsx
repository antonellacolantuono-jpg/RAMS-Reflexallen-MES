...
// ============================================================
const SOURCES = ['styles/tokens.css', 'primitives.jsx', 'design-system.jsx'];
    ...
    <div className="px-4 py-4 hairline-b">
      <div className="flex items-center gap-2">
        ...
        <div className="leading-tight">
          ...
          <div className="text-[10px] uppercase tracking-[0.15em] text-[var(--ink-3)]">v0.4 · live</div>
        </div>
      </div>
    ...
    <div className={cx('flex items-center justify-center p-8', stacked ? 'h-56' : 'h-32')}>
      {stacked ? (
        <div className="flex flex-col items-center gap-3">
          <img src={dark ? window.__resources.logoLight : window.__resources.logoDark} className="w-16 h-16 block" alt="" />
        ...
        <div className="flex items-center gap-5">
          <img src={dark ? window.__resources.logoLight : window.__resources.logoDark} className="w-16 h-16" alt="" />
          <div>
...
const BrandSection = () => (
  <Section id="brand" label="Brand" title="Brand & logo" sub="Reflex Allen is the parent brand. RAMS is the product. The product lockup pairs the Reflex Allen logomark with the RAMS wordmark in Fahkwang and the payoff in Avenir.">
    ...
    <div className="grid grid-cols-2 gap-3 mb-3">
      <LogoTile src={window.__resources.completedDark} label="Completed lockup · light" sub="external · covers" />
      <LogoTile dark src={window.__resources.completedLight} label="Completed lockup · dark" sub="external · covers" />
      <LogoTile src={window.__resources.nopayoffDark} label="No payoff · light" sub="app chrome" />
      <LogoTile dark src={window.__resources.nopayoffLight} label="No payoff · dark" sub="app chrome · andon" />
      <LogoTile src={window.__resources.logoDark} label="Logomark · light" sub="favicon · tight space" />
      <LogoTile dark src={window.__resources.logoLight} label="Logomark · dark" sub="favicon · tight space" />
    </div>
    ...
    <ToastProvider>
      <div className="flex">
        ...
        <main className="flex-1 min-w-0">
          ...
          <PageHeaderSection />
          <PhaseBarSection />
          <div className="py-12 text-center text-[11px] text-[var(--ink-3)] mono">— end of design system · v0.4 —</div>
        </main>
      </div>
    </ToastProvider>
  );
