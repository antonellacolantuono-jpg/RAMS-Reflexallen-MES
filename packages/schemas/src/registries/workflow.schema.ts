...
// `photoUrl` accepts either a short URL or a base64 data URL (~666KB for a
// 500KB raw image); see TODO-066 for the S3 migration.
export const StepDataSchema = z
  .object({
    recoveryConfig: StepRecoveryConfigSchema.optional(),
    photoUrl: z.string().max(700_000).optional(),
