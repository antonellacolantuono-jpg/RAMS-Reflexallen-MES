...
// ============================================================
const SOURCES = ['styles/tokens.css', 'primitives.jsx', 'design-system.jsx', 'design-system-dashboard.jsx', 'design-system-views.jsx', 'design-system-tables.jsx'];
...
const SECTIONS = [
  ...
  { id: 'op-tables', label: 'Operational Table', items: [
    { id: 'op-table', label: 'Full pattern' },
  ]},
];
    ...
    <div className="px-4 py-4 hairline-b">
      <div className="flex items-center gap-2">
        ...
        <div className="leading-tight">
          ...
          <div className="text-[10px] uppercase tracking-[0.15em] text-[var(--ink-3)]">v0.7 · live</div>
        </div>
      </div>
...
const GITHUB_URL = 'https://github.com/antonellacolantuono-jpg/RAMS-Reflexallen-MES';
    ...
    <FormCard className="overflow-hidden">
      ...
      <FormRow label="Link code on GitHub">
        <div className="hairline rounded-[var(--r-1)] bg-[var(--paper-2)] px-2.5 h-9 flex items-center text-[12.5px] mono">
          ...
          <a href="https://github.com/antonellacolantuono-jpg/RAMS-Reflexallen-MES" target="_blank" rel="noreferrer" className="text-[var(--accent-ink)] hover:underline truncate">
            github.com/antonellacolantuono-jpg/RAMS-Reflexallen-MES
          </a>
          <span className="ml-2 text-[9.5px] mono uppercase tracking-[0.12em] text-[var(--accent-ink)] bg-[var(--accent-soft)] px-1.5 py-0.5 rounded flex-shrink-0">monorepo</span>
    ...
    <ToastProvider>
      <div className="flex">
        ...
        <main className="flex-1 min-w-0">
          ...
          {window.OperationalTableSections && <window.OperationalTableSections />}
          <div className="py-12 text-center text-[11px] text-[var(--ink-3)] mono">— end of design system · v0.7 —</div>
        </main>
      </div>
    </ToastProvider>
  );
